<div class="container-fluid">
  	...
  	<div class="card shadow mb-4">
          ...
          <h6 class="m-0 font-weight-bold text-primary">Data Pengambilan
  				...
  				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
  					...
  					<tbody>
						...
						<td>
							...
							<a class="btn btn-primary " href="<?= base_url('Login/print/'.$am->id_pengambil);?>"><i class="fa fa-print"></i>Print</a> 
                        </td>
						</tr>
						<?php endforeach;
                        ?>
